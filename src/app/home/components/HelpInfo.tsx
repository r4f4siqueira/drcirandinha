...
import { Box, Heading, Link, List, Mark, Text } from "@chakra-ui/react";
...
export const HelpInfo = () => {
  return (
    <Box>
      ...
      <List.Root ml={8}>
        <List.Item>
          <Text fontSize="lg" color={"yellow.fg"} fontWeight={"bold"}>
        ...
        <List.Item>
          <Text fontSize="lg">
            ...
            Por aqui você pode acompanhar minhas metas, rankings de doações e
            muito mais.
          </Text>
        </List.Item>
        <List.Item>
